...
class BaseHexarotorCfg:
    ...
    class robot_asset:
        asset_folder = f"{AERIAL_GYM_DIRECTORY}/resources/robots/hexarotor"
        file = "hexa.urdf"
        name = "base_hexarotor"  # actor name
    ...
    class control_allocator_config:
        ...
        application_mask = [1 + 6 + i for i in range(0, 6)]
        ...
        allocation_matrix = [
            ...
            [ -0.1838477631, -0.091923882, 0.091923882, 0.1838477631, 0.091923882,  -0.091923882],  # Roll torque contributions
            [0.0, -0.159216833, -0.159216833, 0.0, 0.159216833, 0.159216833],  # Pitch torque contributions
            [-0.01, 0.01, -0.01, 0.01, -0.01, 0.01]  # Yaw torque contributions
        ]
