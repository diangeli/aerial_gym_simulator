...
from aerial_gym.config.robot_config.base_hexarotor_config import BaseHexarotorCfg
...
robot_registry.register("base_hexarotor", BaseMultirotor, BaseHexarotorCfg)
